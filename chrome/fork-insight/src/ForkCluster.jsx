...
//   const navigate = useNavigate();
  ...
  return (
    <Box style={{marginTop: 20, marginLeft: 20}}>
      <Box>
        <Typography variant="h5">Fork Clustering</Typography>
          ...
          <Grid container alignItems="center" paddingBottom={1}>
            ...
            <Grid item marginTop={1}>
              ...
              <Grid item>
                  <Grid container>
                    <Grid item marginTop={1}>
                      <Typography>Analyze Options:</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item>
                ...
                <Grid item>
                  <Grid container>
                    ...
                    <Grid item marginTop={1}>
                      <Typography>Commit Messages</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item>
                  <Grid container>
                    ...
                    <Grid item marginTop={1}>
                      <Typography>Use Recent</Typography>
                    </Grid>
                  </Grid>
                </Grid>
              </Grid>
